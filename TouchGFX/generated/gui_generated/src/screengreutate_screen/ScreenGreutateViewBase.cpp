...
ScreenGreutateViewBase::ScreenGreutateViewBase() :
    flexButtonCallback(this, &ScreenGreutateViewBase::flexButtonCallbackHandler)
{
    ...
    textArea3.setTypedText(touchgfx::TypedText(T___SINGLEUSE_VJR4));
    add(textArea3);
    ...
    Unicode::snprintf(textAreaMarime_2Buffer, TEXTAREAMARIME_2_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_PQ82).getText());
    textAreaMarime_2.setWildcard(textAreaMarime_2Buffer);
    textAreaMarime_2.setTypedText(touchgfx::TypedText(T___SINGLEUSE_7LK6));
    ...
    Unicode::snprintf(textAreaMarimeBuffer, TEXTAREAMARIME_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_M19B).getText());
    textAreaMarime.setWildcard(textAreaMarimeBuffer);
    textAreaMarime.setTypedText(touchgfx::TypedText(T___SINGLEUSE_THS5));
    add(textAreaMarime);

    textArea2.setPosition(0, 74, 240, 46);
    textArea2.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    textArea2.setLinespacing(0);
    Unicode::snprintf(textArea2Buffer, TEXTAREA2_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_NGJ9).getText());
    textArea2.setWildcard(textArea2Buffer);
    textArea2.setTypedText(touchgfx::TypedText(T___SINGLEUSE_DV78));
    add(textArea2);

    textArea1.setPosition(0, 0, 190, 46);
    textArea1.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    textArea1.setLinespacing(0);
    Unicode::snprintf(textArea1Buffer, TEXTAREA1_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_TEXF).getText());
    textArea1.setWildcard(textArea1Buffer);
    textArea1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_1VZN));
    add(textArea1);

    flexButtonPoint.setBoxWithBorderPosition(0, 0, 76, 27);
    ...
    flexButtonPoint.setPosition(161, 289, 76, 27);
    add(flexButtonPoint);
}
...
void ScreenGreutateViewBase::setupScreen()
{

}

void ScreenGreutateViewBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
    ...
    {
        //Interaction14
        //When flexButton1 clicked change screen to ScreenListMasa
        //Go to ScreenListMasa with no screen transition
        application().gotoScreenListMasaScreenNoTransition();
    }
    if (&src == &flexButton2)
    {
        //Interaction15
        //When flexButton2 clicked change screen to ScreenListMasa_1
        //Go to ScreenListMasa_1 with no screen transition
        application().gotoScreenListMasa_1ScreenNoTransition();
    }
