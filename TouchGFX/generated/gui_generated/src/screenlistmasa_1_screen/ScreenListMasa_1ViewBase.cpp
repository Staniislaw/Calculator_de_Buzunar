...
ScreenListMasa_1ViewBase::ScreenListMasa_1ViewBase() :
    buttonCallback(this, &ScreenListMasa_1ViewBase::buttonCallbackHandler),
    radioButtonSelectedCallback(this, &ScreenListMasa_1ViewBase::radioButtonSelectedCallbackHandler)
{
    ...
    textArea1_1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_HJCA));
    add(textArea1_1);

    textArea1_2.setXY(36, 78);
    textArea1_2.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    textArea1_2.setLinespacing(0);
    textArea1_2.setTypedText(touchgfx::TypedText(T___SINGLEUSE_RB8A));
    add(textArea1_2);
    ...
    textArea1_2_1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_940V));
    add(textArea1_2_1);

    textArea1.setXY(36, 42);
    textArea1.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    textArea1.setLinespacing(0);
    textArea1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_9KZW));
    add(textArea1);
...
void ScreenListMasa_1ViewBase::setupScreen()
{

}

void ScreenListMasa_1ViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
...
void ScreenListMasa_1ViewBase::radioButtonSelectedCallbackHandler(const touchgfx::AbstractButton& src)
{
