...
ScreenLungimeViewBase::ScreenLungimeViewBase() :
    flexButtonCallback(this, &ScreenLungimeViewBase::flexButtonCallbackHandler)
{
    ...
    textArea3.setTypedText(touchgfx::TypedText(T___SINGLEUSE_HWS8));
    add(textArea3);
    ...
    Unicode::snprintf(textAreaMarime_2Buffer, TEXTAREAMARIME_2_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_RM6S).getText());
    textAreaMarime_2.setWildcard(textAreaMarime_2Buffer);
    textAreaMarime_2.setTypedText(touchgfx::TypedText(T___SINGLEUSE_STEH));
    ...
    Unicode::snprintf(textAreaMarimeBuffer, TEXTAREAMARIME_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_A4LQ).getText());
    textAreaMarime.setWildcard(textAreaMarimeBuffer);
    textAreaMarime.setTypedText(touchgfx::TypedText(T___SINGLEUSE_F1YA));
    add(textAreaMarime);

    textArea2.setPosition(0, 74, 240, 46);
    textArea2.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    textArea2.setLinespacing(0);
    Unicode::snprintf(textArea2Buffer, TEXTAREA2_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_N9T6).getText());
    textArea2.setWildcard(textArea2Buffer);
    textArea2.setTypedText(touchgfx::TypedText(T___SINGLEUSE_CNVE));
    add(textArea2);

    textArea1.setPosition(0, 0, 190, 46);
    textArea1.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    textArea1.setLinespacing(0);
    Unicode::snprintf(textArea1Buffer, TEXTAREA1_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_F2QF).getText());
    textArea1.setWildcard(textArea1Buffer);
    textArea1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_BUQ3));
    add(textArea1);
...
void ScreenLungimeViewBase::setupScreen()
{

}

void ScreenLungimeViewBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
    ...
    {
        //Interaction14
        //When flexButton1 clicked change screen to ScreenListLungime
        //Go to ScreenListLungime with no screen transition
        application().gotoScreenListLungimeScreenNoTransition();
    }
    if (&src == &flexButton2)
    {
        //Interaction15
        //When flexButton2 clicked change screen to ScreenListLungime_1
        //Go to ScreenListLungime_1 with no screen transition
        application().gotoScreenListLungime_1ScreenNoTransition();
    }
