...
ScreenListTimpViewBase::ScreenListTimpViewBase() :
    buttonCallback(this, &ScreenListTimpViewBase::buttonCallbackHandler),
    radioButtonSelectedCallback(this, &ScreenListTimpViewBase::radioButtonSelectedCallbackHandler)
{
    ...
    textArea1_1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_I35M));
    add(textArea1_1);

    textArea1_2.setXY(36, 78);
    textArea1_2.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    textArea1_2.setLinespacing(0);
    textArea1_2.setTypedText(touchgfx::TypedText(T___SINGLEUSE_U65O));
    add(textArea1_2);
    ...
    textArea1_2_1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_GC6O));
    add(textArea1_2_1);
    ...
    textArea1_2_2.setTypedText(touchgfx::TypedText(T___SINGLEUSE_3VRY));
    add(textArea1_2_2);
    ...
    textArea1_2_2_1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_2218));
    add(textArea1_2_2_1);
    ...
    textArea1_2_2_1_1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_YS8J));
    add(textArea1_2_2_1_1);

    textArea1.setXY(36, 42);
    textArea1.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    textArea1.setLinespacing(0);
    textArea1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_KK0P));
    add(textArea1);
    ...
    radioButtonS.setBitmaps(touchgfx::Bitmap(BITMAP_CLAY_THEME_IMAGES_WIDGETS_RADIOBUTTON_RADIO_MEDIUM_ROUND_OFF_ID), touchgfx::Bitmap(BITMAP_CLAY_THEME_IMAGES_WIDGETS_RADIOBUTTON_RADIO_MEDIUM_ROUND_OFF_PRESSED_ID), touchgfx::Bitmap(BITMAP_CLAY_THEME_IMAGES_WIDGETS_RADIOBUTTON_RADIO_MEDIUM_ROUND_ON_DARK_ID), touchgfx::Bitmap(BITMAP_CLAY_THEME_IMAGES_WIDGETS_RADIOBUTTON_RADIO_MEDIUM_ROUND_ON_PRESSED_ID));
    ...
    radioButtonMin.setBitmaps(touchgfx::Bitmap(BITMAP_CLAY_THEME_IMAGES_WIDGETS_RADIOBUTTON_RADIO_MEDIUM_ROUND_OFF_ID), touchgfx::Bitmap(BITMAP_CLAY_THEME_IMAGES_WIDGETS_RADIOBUTTON_RADIO_MEDIUM_ROUND_OFF_PRESSED_ID), touchgfx::Bitmap(BITMAP_CLAY_THEME_IMAGES_WIDGETS_RADIOBUTTON_RADIO_MEDIUM_ROUND_ON_DARK_ID), touchgfx::Bitmap(BITMAP_CLAY_THEME_IMAGES_WIDGETS_RADIOBUTTON_RADIO_MEDIUM_ROUND_ON_PRESSED_ID));
    ...
    radioButtonOre.setBitmaps(touchgfx::Bitmap(BITMAP_CLAY_THEME_IMAGES_WIDGETS_RADIOBUTTON_RADIO_MEDIUM_ROUND_OFF_ID), touchgfx::Bitmap(BITMAP_CLAY_THEME_IMAGES_WIDGETS_RADIOBUTTON_RADIO_MEDIUM_ROUND_OFF_PRESSED_ID), touchgfx::Bitmap(BITMAP_CLAY_THEME_IMAGES_WIDGETS_RADIOBUTTON_RADIO_MEDIUM_ROUND_ON_DARK_ID), touchgfx::Bitmap(BITMAP_CLAY_THEME_IMAGES_WIDGETS_RADIOBUTTON_RADIO_MEDIUM_ROUND_ON_PRESSED_ID));
    ...
    radioButtonSapt.setBitmaps(touchgfx::Bitmap(BITMAP_CLAY_THEME_IMAGES_WIDGETS_RADIOBUTTON_RADIO_MEDIUM_ROUND_OFF_ID), touchgfx::Bitmap(BITMAP_CLAY_THEME_IMAGES_WIDGETS_RADIOBUTTON_RADIO_MEDIUM_ROUND_OFF_PRESSED_ID), touchgfx::Bitmap(BITMAP_CLAY_THEME_IMAGES_WIDGETS_RADIOBUTTON_RADIO_MEDIUM_ROUND_ON_DARK_ID), touchgfx::Bitmap(BITMAP_CLAY_THEME_IMAGES_WIDGETS_RADIOBUTTON_RADIO_MEDIUM_ROUND_ON_PRESSED_ID));
...
void ScreenListTimpViewBase::setupScreen()
{

}

void ScreenListTimpViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
...
void ScreenListTimpViewBase::radioButtonSelectedCallbackHandler(const touchgfx::AbstractButton& src)
{
