...
/*********************************************************************************/
#ifndef SCREENTIMPVIEWBASE_HPP
#define SCREENTIMPVIEWBASE_HPP
...
class ScreenTimpViewBase : public touchgfx::View<ScreenTimpPresenter>
{
public:
    ScreenTimpViewBase();
    virtual ~ScreenTimpViewBase();
    ...
    {
        // Override and implement this function in ScreenTimp
    }
...
private:
     ...
     */
    touchgfx::Callback<ScreenTimpViewBase, const touchgfx::AbstractButtonContainer&> flexButtonCallback;
